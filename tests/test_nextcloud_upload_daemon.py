...
class TestFileWatcher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.watcher = FileWatcher(self.mock_uploader, "/local/path", "/remote/path", self.mock_queue)
...
class TestConfigLoading(unittest.TestCase):
    ...
    def test_load_valid_config(self):
        ...
        config_data = {
            ...
            "directories": [{"local": "/local1", "remote": "/remote1"}, {"local": "/local2", "remote": "/remote2"}],
        }
    ...
    def test_load_config_with_defaults(self):
        ...
        config_data = {
            ...
            "username": "user",
            "password": "pass",
            "directories": [{"local": "/local1", "remote": "/remote1"}],
        }
    ...
    def test_load_config_invalid_directory_entry(self):
        ...
        config_data = {
            ...
            "username": "user",
            "password": "pass",
            "directories": [{"local": "/local1"}],  # Missing remote field
        }
...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        config_data = {
            ...
            "directories": [{"local": self.temp_dir, "remote": "/remote"}],
        }
    ...
    def test_config_and_processor_integration(self):
        ...
        processor = FileProcessor(mock_uploader, config["upload_delay_seconds"], config["delete_delay_seconds"])
    ...
    def test_watcher_and_processor_integration(self, mock_queue_class):
        ...
        FileProcessor(mock_uploader, 1, 2)  # Test initialization only
